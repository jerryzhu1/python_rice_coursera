...
def new_game():
    ...
    direction_1 = random.choice(['LEFT', 'RIGHT'])
    spawn_ball(direction_1)
...
def draw(canvas):
    ...
    # vertical collision
    if ball_pos[1] < BALL_RADIUS - ball_vel[1] or ball_pos[1] > HEIGHT - BALL_RADIUS - ball_vel[1]:
        ball_vel[1] = -ball_vel[1]

    # horizontal collition

    if ball_pos[0] < PAD_WIDTH + BALL_RADIUS - ball_vel[0]:
    ...
    elif ball_pos[0] > WIDTH - PAD_WIDTH - BALL_RADIUS - ball_vel[0]:
    ...
    # draw scores
    canvas.draw_text(str(score1), (WIDTH / 2 - 60,50), 40, "White")
    canvas.draw_text(str(score2), (WIDTH / 2 + 40,50), 40, "White")
